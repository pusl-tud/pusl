 ...
 *
 **/
@PageTitle("Zentraldatei | Benutzer verwalten")
@Route(value = ManageUserView.ROUTE, layout = MainAppView.class)
public class ManageUserView extends BaseView {

	private static final long serialVersionUID = 1L;
	
	public static final String ROUTE = "manage-user";
	...
	private Button createUserButton(User item) {
		Button button = new Button(item.getLastName(), clickEvent -> {
			UI.getCurrent().navigate(EditUserView.ROUTE  + "/" + item.getId());
		});
