...
public class InstituteServiceIT {
    ...
    public void testGetById() throws Exception {
        ...
        assertThrows(DataNotFoundException.class,
                () -> instituteService.getById(RandomStringUtils.randomAlphanumeric(8)));
        ...
        assertEquals(institute2, instituteService.getById(institute2.getId().toString()));
    }
    ...
    public void testCheckNameAvailable() {
        ...
        assertTrue(instituteService.checkNameAvailable(RandomStringUtils.randomAlphanumeric(7), Optional.of(institute1.getId())));
