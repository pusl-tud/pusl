...
/**
 * IntegrationTest for {@link ExerciseSchemeService}
 * 
 * @author Leon Chemnitz
 */
@SpringBootTest(webEnvironment = WebEnvironment.MOCK)
 public class ExerciseSchemeServiceIT {
    private static final Logger LOGGER = LoggerFactory.getLogger(ExerciseSchemeServiceIT.class);
    ...
    public void testSave() throws Exception {
        ...
        exerciseScheme.setInstitutes(Sets.newSet(institute.getId()));
